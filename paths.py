...
tif_dir_naip = drive + "data/tif/unprocessed_naip_10mTEST/"
tif_dir_nlcd = drive + "data/tif/unprocessed_nlcd_10mTEST/"
...
train_images = drive + "data/npy/train_mini/" # contains train images
...
train_tiles = drive + "data/tiles_10m_smart/train/"  # train tiles (triplets)
...
train_tiles_nlcd = drive + "data/tiles_10m_smart/train_nlcd/"
